...
import com.example.mediademo.databinding.ActivityCameraBinding;
...
public class CameraActivity extends AppCompatActivity {
    ...
    private void showErrorToast(@NonNull String message) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            runOnUiThread(() -> Toast.makeText(CameraActivity.this, message, Toast.LENGTH_SHORT).show());
        }
    }
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton(getString(R.string.capture_permission_ok), new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                ActivityCompat.requestPermissions(CameraActivity.this, deniedPermission.toArray(denied), PERMISSION_CODE);
                            }
                        }).create().show();
            }
        }
